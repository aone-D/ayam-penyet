                    ...
                    <form method="POST" action="{{ route('bahan-baku.store') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('penggunaan') is-invalid @enderror" id="penggunaan" name="penggunaan" value="{{ old('penggunaan') }}" required>
                                    @error('penggunaan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('satuan_pakai') is-invalid @enderror" id="satuan_pakai" name="satuan_pakai" required>
                                ...
                                <option value="potong" {{ old('satuan_pakai') == 'potong' ? 'selected' : '' }}>potong</option>
